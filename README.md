React + TypeScript Assignment: To-Do List App

Objective
  Build a single-page To-Do List application using React.js and Nodejs with TypeScript. The app should allow users to create, edit, and delete tasks. Additionally, each task row should have a different background color based on the current date and task completion status.
...
Submission
Please submit your solution as a zip file containing the project. Make sure to include a README file with setup instructions.
Good luck!
